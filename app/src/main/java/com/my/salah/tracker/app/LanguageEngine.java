...
public class LanguageEngine {
    ...
    public LanguageEngine(String lang) {
        ...
        bnMap.put("Muharram", "মুহররম"); bnMap.put("Safar", "সফর"); bnMap.put("Rabi I", "রবিউল আউয়াল");
        bnMap.put("Rabi II", "রবিউল আখির"); 
        bnMap.put("Jumada I", "জুমাদাল ঊলা"); bnMap.put("Jumada II", "জুমাদাল উখরা"); bnMap.put("Rajab", "রজব"); bnMap.put("Sha'ban", "শাবান"); 
        bnMap.put("Ramadan", "রমজান"); bnMap.put("Shawwal", "শাওয়াল");
        bnMap.put("Dhu al-Qi'dah", "জিলকদ"); bnMap.put("Dhu al-Hijjah", "জিলহজ");
        ...
        bnMap.put("Success", "সফল"); bnMap.put("Error", "ত্রুটি");
