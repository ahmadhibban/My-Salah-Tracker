...
public class SyncWorker extends Worker
{
    ...
    @NonNull @Override public Result doWork()
    {
        SharedPreferences sp =
            getApplicationContext().getSharedPreferences("salah_pro_final", Context.MODE_PRIVATE);
                ...
                if (parts.length == 3) {
                    try {
                        java.net.URL url = new java.net.URL(
                            "https://mysalahtracker-49a76-default-rtdb.firebaseio.com/users/"
                            + safeEmail + "/" + parts[0] + "_" + parts[1] + ".json");
