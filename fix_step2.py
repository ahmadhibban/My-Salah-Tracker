...
mgr = r'''private ZikrManager zikrMan = null;
    static class ZikrManager {
        ...
        void init(android.content.Context ctx) {
            try {
                prefs = ctx.getSharedPreferences("TasbihPrefs_v7", android.content.Context.MODE_PRIVATE);
                if(tasbihList.isEmpty()) {
                    String[] raw = {"سُبْحَانَ اللّٰهِ|33|সুবহানাল্লাহ|আল্লাহ পবিত্র ও মহিমান্বিত", "الْحَمْدُ لِلّٰهِ|33|আলহামদুলিল্লাহ|যাবতীয় প্রশংসা আল্লাহর জন্য", "اللّٰهُ أَكْبَرُ|34|আল্লাহু আকবার|আল্লাহ সর্বশ্রেষ্ঠ", "لَا إِلٰهَ إِلَّا اللّٰهُ مُحَمَّدٌ رَسُولُ اللّٰهِ|0|লা ইলাহা ইল্লাল্লাহু মুহাম্মাদুর রাসুলুল্লাহ|আল্লাহ ছাড়া কোনো ইলাহ নেই", "أَسْتَغْفِرُ اللّٰهَ وَأَتُوبُ إِلَيْهِ|100|আস্তাগফিরুল্লাহ ওয়া আতুবু ইলাইহি|আমি আল্লাহর কাছে ক্ষমা চাই এবং তাঁর দিকে ফিরে যাই", "لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللّٰهِ|0|লা হাওলা ওয়ালা কুওয়াতা ইল্লা বিল্লাহ|আল্লাহ ছাড়া কোনো ক্ষমতা ও শক্তি নেই"};
...
c = c.replace('// ZIKR_PLACEHOLDER', mgr)
