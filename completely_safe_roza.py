...
def main():
    ...
    if target_main:
        ...
        # ১. অটো-ট্রান্সলেটর মেথড নিরাপদে যুক্ত করা
...
"""
        ...
        # শুধু নির্দিষ্ট কয়েকটি লেখায় ট্রান্সলেটর বসানো
        ...
        rTitle.setText(isBn ? "রোজা" : "Fasting");
        ...
        rCatBtn.setText(isBn ? "ক্যাটাগরি ▼" : "Category ▼");
        ...
        rCatBtn.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                ...
                b.setTitle(isBn ? "রোজার ধরন" : "Fasting Type");
        ...
        // --- ROZA TRACKER END ---
"""
        # শুধুমাত্র ফন্ট অ্যাপ্লাই করার ঠিক আগে রোজার কার্ড বসানো হচ্ছে (অন্য কোথাও না)
        if 'ROZA TRACKER START' not in content:
            content = content.replace("applyFont(main, appFonts[0], appFonts[1]);", roza_code + "\n        applyFont(main, appFonts[0], appFonts[1]);")

        with open(target_main, 'w', encoding='utf-8') as f:
            f.write(content)
        print("✅ পারফেক্ট! আপনার আগের ডিজাইনে বিন্দুমাত্র আঘাত না করে শুধু অটো-ট্রান্সলেশন এবং রোজার কার্ড যুক্ত করা হয়েছে।")
    else:
