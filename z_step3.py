...
canvas_pt1 = r'''class ZikrCanvasView extends android.view.View {
        ...
        // ZIKR_EVENTS_PLACEHOLDER
    '''
c = c.replace('// ZIKR_CANVAS_PLACEHOLDER', canvas_pt1)
open(f, 'w', encoding='utf-8').write(c)
print("✅ Step 3: Canvas UI Updated perfectly.")
