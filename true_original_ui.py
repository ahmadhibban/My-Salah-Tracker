...
if start_idx != -1 and end_idx != -1:
    perfect_code = """for(int i=0; i<6; i++) {
            ...
            // ১. অরিজিনাল কার্ড সাইজ ও প্যাডিং (অতিরিক্ত ফাঁকা জায়গা কমানো হয়েছে)
            ...
            if (AppConstants.SUNNAHS[i].length > 0 && !stat.equals("excused")) {
                ...
                // হারানো সুন্নাহ বাটনের অরিজিনাল সুন্দর ব্যাকগ্রাউন্ড ফিরিয়ে আনা হলো
                ...
                sunnahBtn.setPadding((int)(8*DENSITY), (int)(2*DENSITY), (int)(8*DENSITY), (int)(2*DENSITY));
                
                LinearLayout.LayoutParams sunnahLp = new LinearLayout.LayoutParams(-2, -2); 
                sunnahLp.setMargins(0, (int)(4*DENSITY), 0, 0); 
    ...
    print("PERFECT 1:1 Original UI restored!")
else:
